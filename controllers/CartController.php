...
class CartController
{
    ...
    function indexAction($smarty)
    {
        ...
        $rsProducts = $this->product->getProductsfromArray($itemsIds);
        ...
        Router::loadTemplate($smarty, 'cart');
    ...
    function orderAction($smarty)
    {
        ...
        $rsProducts = $this->product->getProductsfromArray($itemIds);
        ...
        Router::loadTemplate($smarty, 'header');
        Router::loadTemplate($smarty, 'order');
        Router::loadTemplate($smarty, 'footer');
    }
    ...
    function saveorderAction()
    {
        ...
        $orderId = $this->order->makeNewOrder($name, $phone, $address);
